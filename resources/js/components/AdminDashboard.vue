<template>
    <div>
        ...
        <button class="add"><a href="/admin/dashboard/import">IMPORT DEGREES</a></button>
        <div v-show="isShow">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <button class="btn btn-primary"
                                        @click="createUser(), flashMessage.success({ message:'Successfully created '+user.name+ '|email: '+ user.email, time:4000 });">
                                    Create User
                                </button>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="text" v-model="search" v-on:keyup.enter="searchUser()" class="form-control"
                               placeholder="name, email, dept. id, role...">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <transition-group name="slide-fade" tag="tbody">
                                        <tr v-for="( sear,index1 ) in searchArr" v-bind:key="sear.id">
                                            ...
                                            <td v-else>
                                                <input type="text" v-model="selectedUser.department_id"
                                                       class="form-control">
                                            </td>

                                            <td v-if="!sear.isEdit">{{ sear.account_type }}</td>
                                            <td v-else>
                                                <input type="text" v-model="selectedUser.account_type"
                                                       class="form-control">
                                            </td>
                                            ...
                                            <td v-if="checkIsAdmin && !sear.isEdit">
                                                ...
                                                <button class="btn btn-danger" @click="deleteUser(sear, index1)">
                                                    Delete
                                                </button>
                                            </td>
                                            <td v-else>
                                                <button class="btn btn-primary" @click="updateUser(sear)">Save</button>
                                                <button class="btn btn-danger" @click="sear.isEdit = false">Cancel
                                                </button>
                                            </td>
                ...
                <div v-if="showSearch==false">
                    ...
                    <div class="list_user table-responsive container">
                        <table class="table table-hover">
                            ...
                            <transition-group name="slide-fade" tag="tbody">
                                ...
                                <tr v-for="(user, index) in list_users.data" :key="user.id">
                                    ...
                                    <td v-else>
                                        <button class="btn btn-primary"
                                                @click="updateUser(index), flashMessage.success({ title: 'Success', message: user.name + ' is updated!', time:1000 });">
                                            Save
                                        </button>
                        ...
                        <ul class="pagination">
                            ...
                            <li class="page-item" v-if="list_users.prev_page_url"
                                @click="getListUsers(list_users.current_page - 1)">
                                <a class="page-link" href="#">{{ list_users.current_page - 1 }}</a>
                            </li>
                            <li class="page-item active">
                                <a class="page-link" href="#">{{ list_users.current_page }}</a>
                            </li>
                            <li class="page-item" v-if="list_users.next_page_url"
                                @click="getListUsers(list_users.current_page + 1)">
                                <a class="page-link" href="#">{{ list_users.current_page + 1 }}</a>
                            </li>
                            <li
